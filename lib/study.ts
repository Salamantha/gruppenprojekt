export const TOTAL_TRIALS = 2;

/** Builds a balanced, shuffled sequence of conditions for one participant's session.
 * With an odd total, CONTROL trials round down, favoring more FLAWED trials since
 * error-detection is the primary phenomenon under study. */
